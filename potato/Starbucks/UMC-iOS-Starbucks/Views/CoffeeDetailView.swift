...
//        viewModel.selectedCoffee = CoffeeModel(
//            name: "Confanaa",
//            nameEng: "Confanaa",
//            detail: "A rich and full-bodied coffee.",
//            price: "$5.00",
//            image: "confanaa_image",
//            coffeeTypes: [.hot, .ice] // 예시로 핫과 아이스 타입 설정
//        )
//        
        return CoffeeDetailView(viewModel: viewModel)
            .environmentObject(NavigationRouter()) // NavigationRouter 환경 객체 추가
    }
}
