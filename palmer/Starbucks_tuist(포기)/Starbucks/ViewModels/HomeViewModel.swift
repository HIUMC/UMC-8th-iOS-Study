...
@Observable
class HomeViewModel {
    var selectedCoffeeModel: RecommendModel? = RecommendModel(name: "카라멜 마키아또", nameEn: "Caramel Macchiato", image: Image("caramelMacchiato"),
    ...
    let dummyCoffees: [RecommendModel] = [
        RecommendModel(name: "아이스 카라멜 마키아또", nameEn: "Iced Caramel Macchiato", image: Image("iceCaramelMacchiato"),
        ...
        RecommendModel(name: "카라멜 마키아또", nameEn: "Caramel Macchiato", image: Image("caramelMacchiato"),
                    content: "향긋한 바닐라 시럽과 따뜻한 스팀 밀크 위에 풍성한 우유 거품을 얹고 점을 찍듯이 에스프레소를 부은 후 벌집 모양으로 카라멜 드리즐을 올린 달콤한 커피 음료",
                    price: "6,100", temperature: .hot, hasBothTemps: true),
        RecommendModel(name: "아이스 카페 아메리카노", nameEn: "Iced Caffe Americano", image: Image("iceAmericano"),
        ...
        RecommendModel(name: "카페 아메리카노", nameEn: "Caffe Americano", image: Image("cafeAmericano"),
                    content: "진한 에스프레소와 뜨거운 물을 섞어 스타벅스의 깔끔하고 강렬한 에스프레소를 가장 부드럽게 잘 느낄 수 있는 커피",
                    price: "4,700", temperature: .hot, hasBothTemps: true),
        RecommendModel(name: "에스프레소 콘파나", nameEn: "Espresso Con Panna", image: Image("espressoConPanna"),
        ...
        RecommendModel(name: "에스프레소 마키아또", nameEn: "Espresso Con Panna", image: Image("espressoMacchiato"),
