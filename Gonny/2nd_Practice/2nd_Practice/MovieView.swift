...
struct MovieView: View {
    ...
    var body: some View {
        VStack(spacing: 56) {//Spacing: 뷰 각각의 요소 사이의 간격이다!!
    ...
    private var leftRightChange: some View {
        ...
        .frame(width: 256)
        .padding(.vertical, 17) /* 이건 뭘 의미하는 걸까요? 위아래 여백 17pt*/
        .padding(.horizontal, 22) /* 이건 뭘 의미하는 걸까요? 좌우 여백 22pt*/
    }
